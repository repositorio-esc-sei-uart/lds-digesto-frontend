...
export class UserCreateComponent implements OnInit {
  ...
  // Se usan las interfaces específicas
  ...
  constructor(
    ...
    // Inyectar los servicios específicos para los catálogos
    private rolService: RolService,
    private sectorService: SectorService,
    private cargoService: CargoService,
    private estadoUserService: EstadoUserService
  ) {}
...
   */
  private loadLookupData(): void {
    ...
    this.estados$ = this.estadoUserService.getEstadosUser();
